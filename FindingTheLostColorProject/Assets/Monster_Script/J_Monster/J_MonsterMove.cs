...
public class J_EnemyMove : MonoBehaviour
{
    ...
    [Tooltip("Animator Controller ���� Idle ����(State) �̸�. ���� ����/����� ���ߴ� ���� �� ���·� ��� ���� ��ȯ�Ͽ�, " +
             "Walk �ִϸ��̼��� �ܿ� Ʈ�������� ���� ���� �ִϸ��̼ǰ� ���� ���̴� ������ ������.")]
    public string idleStateName = "04_FullpulpiCat_IDLE";
    [Tooltip("Idle ���°� ��ġ�� Animator ���̾� �ε��� (���� 0 = Base Layer)")]
    public int idleAnimatorLayer = 0;

    bool idleForced = false; // �̹� ����(isStateDelay) �������� �̹� Idle�� ���� ���Խ��״��� ���� (�ߺ� Play ����)
    ...
    {
        // �������� frontPos�� ���� �߾�(transform.position) ���̿��� �����ؼ�,
        // ���� �߾Ӻ��� ���� ���� lowHit�� �ƿ� �ƹ��͵� ������ ���� �׻� false(������ �Ұ�)��
        // �����Ǵ� ������ �־���. ���� �������� �߹�(�ݶ��̴� �ϴ�)���� ���缭
        // � ������ ���̵� lowHit�� ���������� �����ǵ��� ��
